(module
 ...
 (table 2 2 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN2a15helloEy)
 (memory $0 1)
 ...
 (func $apply (param $0 i64) (param $1 i64) (param $2 i64)
  ...
  (block $label$13
   ...
   (drop
    (call $_ZN5eosio14execute_actionI2a1S1_JyEEEbPT_MT0_FvDpT1_E
     (i32.add
      (get_local $9)
      (i32.const 24)
     )
 ...
 (func $_ZN2a15helloEy (type $FUNCSIG$vij) (param $0 i32) (param $1 i64)
  (call $prints
   (i32.const 128)
  )
  (call $printn
 ...
 (func $_ZN5eosio14execute_actionI2a1S1_JyEEEbPT_MT0_FvDpT1_E (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i64)
  (local $4 i32)
  (local $5 i32)
